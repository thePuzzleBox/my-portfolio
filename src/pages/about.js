    ...
    <div className="row">
      ...
      <div className="col-lg-8 mx-auto">
        ...
        <p className="fg text-black">
          ...
          <br/><br/> Since then, Jalen's commitment to education, reforestation, and conservation storytelling has led him to work and film in communities worldwide. From sailing on expedition across Indonesia to planting trees across South America, he has lived in some
