    ...
    <div className="row">
      ...
      <div className="col-lg-8 mx-auto">
        ...
        <p className="fg text-black">
          ...
          an extensive background in advocacy, Jalen sought to do meaningful work in visual storytelling. Since then, his commitment to conservation, reforestation, and storytelling has led him to work and film in communities worldwide.
          
          
          <br/><br/> Having lived in some of the most remote places on Earth, Jalen found his passion for nature and for sharing it. From sailing on expedition across Indonesia to planting trees across South America, he has found himself
