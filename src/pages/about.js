    ...
    <div className="row">
      ...
      <div className="col-lg-8 mx-auto">
        ...
        <p className="fg text-black">
          ...
          in the presence of exceptionally diverse fauna, ecosystems, and alternative ways of life. As a result, he aims to share this wealth and knowledge of the natural world, and encourage lifelong learning from its stories of preservation.
