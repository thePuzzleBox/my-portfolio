...
import portrait from '../assets/images/hi.jpg';
    ...
    <div className="row">
      ...
      <div className="col-lg-8 mx-auto">
        ...
        <p className="fg text-black">
          ...
          <br/><br/> Taking the opportunity to live remotely in South Africa, Jalen found his passion for nature and for sharing it. This experience served as the basis for his senior thesis. When he returned home in 2023, Jalen became an urban forester, teaching high school students 
