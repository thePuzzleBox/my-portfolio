    ...
    <div className="row">
      ...
      <div className="col-lg-8 mx-auto">
        ...
        <p className="fg text-black">
          ...
          an extensive background in human rights advocacy, Jalen sought to do meaningful work in visual storytelling. He is currently on a mission to travel, capture the natural world, share its stories, and through his work, prompt others to ask themselves what it means to be a part of it.
          
          <br/><br/>Jalen dedicated his senior thesis to the ongoing energy crisis in South Africa, detailing the corruption and downfall of its major utility company, Eskom. In it, he recounts his experience having to deal with the consequences of politics even when living in the African wild.
